...
def main():
    ...
    parser.add_option("-i", "--initialization", dest="initialization", default="LHS",
                      help="INITIALIZATION techique (LHS)", metavar="INITIALIZATION")
    ...
    sys.stdout.write('|   |___/\\___//___|   Surrogate Initialization Script                   |\n')
    sys.stdout.write('|                                                                       |\n')
    sys.stdout.write('-------------------------------------------------------------------------\n')
    ...
    surrogate_initialization( options.filename       ,
                              options.projectname    ,
                              options.partitions     ,
...
def surrogate_initialization( filename                           ,
                              projectname    = ''                ,
                              partitions     = 0                 ,
                              initialization = 'LHS'             ,
                              quiet          = False             ,
    ...
    xb_low            = [-float(config.OPT_LINE_SEARCH_BOUND)]*n_dv      # lower dv bound for SU2_DEF
    xb_up             = [ float(config.OPT_LINE_SEARCH_BOUND)]*n_dv      # upper dv bound for SU2_DEF
    xb                = list(zip(xb_low, xb_up)) # initialization design bounds
