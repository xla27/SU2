history_header_map = {
    ...
    "AVG_CFL": {
        "DESCRIPTION": "Current average of the local CFL numbers",
        "GROUP": "CFL_NUMBER",
        "HEADER": "Avg CFL",
        "TYPE": "DEFAULT",
    },
    ...
    "BGS_DENSITY": {
        "DESCRIPTION": "BGS residual of the density.",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[Rho]",
        "TYPE": "RESIDUAL",
    },
    "BGS_DISP_X": {
        "DESCRIPTION": "BGS residual of X displacement",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[DispX]",
        "TYPE": "RESIDUAL",
    },
    "BGS_DISP_Y": {
        "DESCRIPTION": "BGS residual of Y displacement",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[DispY]",
        "TYPE": "RESIDUAL",
    },
    "BGS_DISP_Z": {
        "DESCRIPTION": "BGS residual of Z displacement",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[DispZ]",
        "TYPE": "RESIDUAL",
    },
    "BGS_DISSIPATION": {
        "DESCRIPTION": "BGS residual of dissipation (SST model).",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[w]",
        "TYPE": "RESIDUAL",
    },
    ...
    "BGS_VELOCITY-X": {
        "DESCRIPTION": "BGS residual of the velocity x-component.",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[U]",
        "TYPE": "RESIDUAL",
    },
    "BGS_VELOCITY-Y": {
        "DESCRIPTION": "BGS residual of the velocity y-component.",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[V]",
        "TYPE": "RESIDUAL",
    },
    "BGS_VELOCITY-Z": {
        "DESCRIPTION": "BGS residual of the velocity z-component.",
        "GROUP": "BGS_RES",
        "HEADER": "bgs[W]",
        "TYPE": "RESIDUAL",
    },
    "BUFFET": {
        "DESCRIPTION": "Buffet sensor",
        "GROUP": "AERO_COEFF",
        "HEADER": "Buffet",
        "TYPE": "COEFFICIENT",
    },
    "CFL_NUMBER": {
        "DESCRIPTION": "Current value of the CFL number",
        "GROUP": "CFL_NUMBER",
        "HEADER": "CFL number",
        "TYPE": "DEFAULT",
    },
    ...
    "CL_DRIVER_COMMAND": {
        "DESCRIPTION": "CL Driver's control command",
        "GROUP": "FIXED_CL",
    ...
    "CREDIBILITY_DRAG": {
        "DESCRIPTION": "Drag credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CD",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_LIFT": {
        "DESCRIPTION": "Lift credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CL",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_SIDEFORCE": {
        "DESCRIPTION": "Sideforce credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CSF",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_MOMENT_X": {
        "DESCRIPTION": "X moment credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CMx",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_MOMENT_Y": {
        "DESCRIPTION": "Y moment credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CMy",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_MOMENT_Z": {
        "DESCRIPTION": "Z moment credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CMz",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_FORCE_X": {
        "DESCRIPTION": "X force credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CFx",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_FORCE_Y": {
        "DESCRIPTION": "Y force credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CFy",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_FORCE_Z": {
        "DESCRIPTION": "Z force credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CFz",
        "TYPE": "CREDIBILITY",
    },
    "CREDIBILITY_EFFICIENCY": {
        "DESCRIPTION": "Efficiency credibility coefficient",
        "GROUP": "AERO_COEFF",
        "HEADER": "Cred_CL/CD",
        "TYPE": "CREDIBILITY",
    },
    ...
    "DEFORM_MAX_VOLUME": {
        "DESCRIPTION": "Maximum volume in the mesh",
        "GROUP": "DEFORM",
        "HEADER": "MaxVolume",
        "TYPE": "DEFAULT",
    },
    "DEFORM_MIN_VOLUME": {
        "DESCRIPTION": "Minimum volume in the mesh",
        "GROUP": "DEFORM",
        "HEADER": "MinVolume",
        "TYPE": "DEFAULT",
    },
    ...
    "DELTA_CL": {
        "DESCRIPTION": "Difference between Target CL and current CL",
        "GROUP": "FIXED_CL",
        "HEADER": "Delta_CL",
        "TYPE": "COEFFICIENT",
    },
    ...
    "D_SURFACE_STATIC_TEMPERATURE": {
        "DESCRIPTION": "Derivative value",
        "GROUP": "D_FLOW_COEFF",
        "HEADER": "d[Avg_Temp]",
        "TYPE": "D_COEFFICIENT",
    },
    "D_SURFACE_TOTAL_PRESSURE": {
        "DESCRIPTION": "Derivative value",
        "GROUP": "D_FLOW_COEFF",
        "HEADER": "d[Avg_TotalPress]",
        "TYPE": "D_COEFFICIENT",
    },
    "D_SURFACE_TOTAL_TEMPERATURE": {
        "DESCRIPTION": "Derivative value",
        "GROUP": "D_FLOW_COEFF",
    ...
    "INVERSE_DESIGN_PRESSURE": {
        "DESCRIPTION": "Cp difference for inverse design",
        "GROUP": "CP_DIFF",
        "HEADER": "Cp_Diff",
        "TYPE": "COEFFICIENT",
    },
    ...
    "LOAD_INCREMENT": {
        "DESCRIPTION": "LOAD_INCREMENT",
        "GROUP": "Percent of total load (incremental",
        "HEADER": "Load[%]",
        "TYPE": "DEFAULT",
    },
    "LOAD_RAMP": {
        "DESCRIPTION": "LOAD_RAMP",
    ...
    "MAX_CFL": {
        "DESCRIPTION": "Current maximum of the local CFL numbers",
        "GROUP": "CFL_NUMBER",
        "HEADER": "Max CFL",
        "TYPE": "DEFAULT",
    },
    "MAX_DELTA_TIME": {
        "DESCRIPTION": "Current maximum local time step",
        "GROUP": "CFL_NUMBER",
        "HEADER": "Max DT",
        "TYPE": "DEFAULT",
    },
    "MAX_DENSITY": {
        "DESCRIPTION": "Maximum square residual of the density.",
        "GROUP": "MAX_RES",
        "HEADER": "max[Rho]",
        "TYPE": "RESIDUAL",
    },
    ...
    "MIN_CFL": {
        "DESCRIPTION": "Current minimum of the local CFL numbers",
        "GROUP": "CFL_NUMBER",
        "HEADER": "Min CFL",
        "TYPE": "DEFAULT",
    },
    "MIN_DELTA_TIME": {
        "DESCRIPTION": "Current minimum local time step",
        "GROUP": "CFL_NUMBER",
        "HEADER": "Min DT",
        "TYPE": "DEFAULT",
    },
    ...
    "REFERENCE_NODE": {
        "DESCRIPTION": "Distance to reference node",
        "GROUP": "STRUCT_COEFF",
        "HEADER": "RefNode",
        "TYPE": "COEFFICIENT",
    },
    ...
    "RMS_DISP_X": {
        "DESCRIPTION": "Residual of X displacement",
        "GROUP": "RMS_RES",
        "HEADER": "rms[DispX]",
        "TYPE": "RESIDUAL",
    },
    "RMS_DISP_Y": {
        "DESCRIPTION": "Residual of Y displacement",
        "GROUP": "RMS_RES",
        "HEADER": "rms[DispY]",
        "TYPE": "RESIDUAL",
    },
    "RMS_DISP_Z": {
        "DESCRIPTION": "Residual of Z displacement",
        "GROUP": "RMS_RES",
        "HEADER": "rms[DispZ]",
        "TYPE": "RESIDUAL",
    },
    ...
    "RMS_UTOL": {
        "DESCRIPTION": "Norm of displacement increment",
        "GROUP": "RMS_RES",
        "HEADER": "rms[U]",
        "TYPE": "RESIDUAL",
    },
    ...
    "STREAMWISE_MASSFLOW": {
        "DESCRIPTION": "Massflow in streamwise periodic flow",
        "GROUP": "STREAMWISE_PERIODIC",
        "HEADER": "SWMassflow",
        "TYPE": "DEFAULT",
    },
    "STRESS_PENALTY": {
        "DESCRIPTION": "Aggregate stress penalty",
        "GROUP": "STRUCT_COEFF",
        "HEADER": "StressPen",
        "TYPE": "COEFFICIENT",
    },
    ...
    "TAVG_SURFACE_MASSFLOW": {
        "DESCRIPTION": "weighted time average value",
        "GROUP": "TAVG_FLOW_COEFF",
        "HEADER": "tavg[Avg_Massflow]",
        "TYPE": "TAVG_COEFFICIENT",
    },
    "TAVG_SURFACE_MOM_DISTORTION": {
        "DESCRIPTION": "weighted time average value",
        "GROUP": "TAVG_FLOW_COEFF",
        "HEADER": "tavg[Momentum_Distortion]",
        "TYPE": "TAVG_COEFFICIENT",
    },
    "TAVG_SURFACE_PRESSURE_DROP": {
        "DESCRIPTION": "weighted time average value",
        "GROUP": "TAVG_FLOW_COEFF",
        "HEADER": "tavg[Pressure_Drop]",
        "TYPE": "TAVG_COEFFICIENT",
    },
    "TAVG_SURFACE_SECONDARY": {
        "DESCRIPTION": "weighted time average value",
        "GROUP": "TAVG_FLOW_COEFF",
    ...
    "TAVG_TOPOL_COMPLIANCE": {
        "DESCRIPTION": "weighted time average value",
        "GROUP": "TAVG_STRUCT_COEFF",
        "HEADER": "tavg[TopComp]",
        "TYPE": "TAVG_COEFFICIENT",
    },
    "TAVG_TOPOL_DISCRETENESS": {
        "DESCRIPTION": "weighted time average value",
        "GROUP": "TAVG_STRUCT_COEFF",
        "HEADER": "tavg[TopDisc]",
        "TYPE": "TAVG_COEFFICIENT",
    ...
    "TORQUE": {
        "DESCRIPTION": "Torque coefficient",
        "GROUP": "ROTATING_FRAME",
        "HEADER": "CQ",
        "TYPE": "COEFFICIENT",
    },
    ...
    "VOLUME_FRACTION": {
        "DESCRIPTION": "Fraction of solid material",
        "GROUP": "STRUCT_COEFF",
        "HEADER": "VolFrac",
        "TYPE": "COEFFICIENT",
    },
