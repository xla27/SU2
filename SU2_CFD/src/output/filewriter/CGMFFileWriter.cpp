/*!
 * \file CGMFFileWriter.cpp
 * \brief Main subroutines for output in Inria GMF format.
 * \author Victorien Menier, B. Munguía
...
#else // Not built with GMF support
