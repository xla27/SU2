...
enum ENUM_OBJECTIVE {
  ...
  CREDIBILITY_LIFT = 70,        
  CREDIBILITY_DRAG = 71,
  CREDIBILITY_SIDEFORCE = 72,
  CREDIBILITY_MOMENT_X = 73,
  CREDIBILITY_MOMENT_Y = 74,
  CREDIBILITY_MOMENT_Z = 75,
  CREDIBILITY_FORCE_X = 76,
  CREDIBILITY_FORCE_Y = 77,
  CREDIBILITY_FORCE_Z = 78,
  CREDIBILITY_EFFICIENCY = 79,
  CREDIBILITY_CUSTOM = 80,
};
static const MapType<std::string, ENUM_OBJECTIVE> Objective_Map = {
  ...
  MakePair("CREDIBILITY_LIFT", CREDIBILITY_LIFT)
  MakePair("CREDIBILITY_DRAG", CREDIBILITY_DRAG)
  MakePair("CREDIBILITY_SIDEFORCE", CREDIBILITY_SIDEFORCE)
  MakePair("CREDIBILITY_MOMENT_X", CREDIBILITY_MOMENT_X)
  MakePair("CREDIBILITY_MOMENT_Y", CREDIBILITY_MOMENT_Y)
  MakePair("CREDIBILITY_MOMENT_Z", CREDIBILITY_MOMENT_Z)
  MakePair("CREDIBILITY_FORCE_X", CREDIBILITY_FORCE_X)
  MakePair("CREDIBILITY_FORCE_Y", CREDIBILITY_FORCE_Y)
  MakePair("CREDIBILITY_FORCE_Z", CREDIBILITY_FORCE_Z)
  MakePair("CREDIBILITY_EFFICIENCY", CREDIBILITY_EFFICIENCY)
  MakePair("CREDIBILITY_CUSTOM", CREDIBILITY_CUSTOM)
};
